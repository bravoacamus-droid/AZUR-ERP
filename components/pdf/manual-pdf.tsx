...
const s = StyleSheet.create({
  ...
  coverLogo: { width: 80, height: 98, marginBottom: 18 },
  coverTitle: { fontSize: 34, fontWeight: 700, color: '#fff', textAlign: 'center', letterSpacing: 0.5 },
  coverSub: { fontSize: 14, color: '#fff', opacity: 0.9, marginTop: 8, textAlign: 'center' },
  coverFooter: { padding: 40, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  coverFooterLabel: { fontSize: 8, color: BRAND.muted, textTransform: 'uppercase', letterSpacing: 1.5 },
  coverFooterValue: { fontSize: 11, color: BRAND.ink, marginTop: 2, fontWeight: 700 },
  coverBadge: {
  ...
  return (
    ...
    >
      ...
      <Page size="A4" style={s.page}>
        ...
        <Toc n="7" titulo="Módulo Finanzas (Solicitudes, Pagos, Cajas)" />
        <Toc n="8" titulo="Módulo Almacén (Central + por proyecto)" />
        <Toc n="9" titulo="PWA Campo (Residente)" />
        <Toc n="10" titulo="Valorizaciones quincenales y Curva S" />
        <Toc n="11" titulo="SST — Seguridad y Salud en el Trabajo" />
        <Toc n="12" titulo="Documentos del proyecto" />
        <Toc n="13" titulo="Dashboard ejecutivo y Auditoría" />
        <Toc n="14" titulo="Notificaciones push" />
        <Toc n="15" titulo="Tipo de cambio SUNAT" />
        <Toc n="16" titulo="Flujo end-to-end de una obra" />
        <Toc n="17" titulo="FAQ y resolución de problemas" />
        <Footer />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>7. Módulo Finanzas</Text>

        <Text style={s.h2}>7.1 Solicitudes de pago</Text>
        <Text style={s.p}>
          Los residentes desde el celular y los administradores desde la web crean solicitudes
          que pasan por aprobación antes de programarse para pago.
        </Text>

        <Text style={s.h3}>Crear solicitud (residente desde PWA)</Text>
        <Step n={1}>
          <Text style={s.p}>PWA → "Pagos" → "Nueva solicitud".</Text>
        </Step>
        <Step n={2}>
          <Text style={s.p}>Llena: proyecto, categoría (proveedor, jornales, caja_chica, agua, alquiler_equipo, flete, servicios, otros), concepto, beneficiario, monto, moneda, urgencia (baja/normal/alta/crítica).</Text>
        </Step>
        <Step n={3}>
          <Text style={s.p}>Enviar. Los 4 aprobadores (gerencia, jefe proyectos, jefe presupuestos, administrador) reciben push si tienen PWA activada.</Text>
        </Step>

        <Text style={s.h3}>Aprobar y procesar (gerencia desde ERP)</Text>
        <Step n={1}>
          <Text style={s.p}>/finanzas/aprobaciones muestra solicitudes pendientes ordenadas por urgencia.</Text>
        </Step>
        <Step n={2}>
          <Text style={s.p}>Click la solicitud → revisa detalles → "Aprobar" (jefatura) o "Rechazar" con motivo. El solicitante recibe push.</Text>
        </Step>
        <Step n={3}>
          <Text style={s.p}>Una vez aprobada, el administrador puede "Programar pago": ingresa fecha, banco origen, banco destino, número de operación.</Text>
        </Step>
        <Step n={4}>
          <Text style={s.p}>Después del pago real, "Subir voucher" → adjunta foto/PDF del comprobante. Estado pasa a "Pagada" + se genera URL pública para compartir por WhatsApp.</Text>
        </Step>

        <Text style={s.h2}>7.2 Cajas</Text>
        <Text style={s.p}>
          Caja central (única) + cajas chicas por proyecto. Movimientos: ingreso, egreso,
          traslado entre cajas.
        </Text>
        <View style={s.noteSuccess}>
          <Text>
            Automatización: cuando se sube un voucher de una solicitud categoría "caja_chica", el
            sistema crea automáticamente el movimiento de traslado de caja central → caja del
            proyecto. Sin doble entrada manual.
          </Text>
        </View>
        <Bullet>Cada proyecto puede tener su caja chica auto-creada al crearse el proyecto.</Bullet>
        <Bullet>Traslados entre cajas son 1 sola operación (no doble).</Bullet>
        <Bullet>Cobros de valorizaciones aprobadas pueden generar auto-ingreso a caja central.</Bullet>

        <Text style={s.h2}>7.3 Reportes financieros</Text>
        <Text style={s.p}>
          /finanzas/reportes genera Excel con: cierre semanal, quincenal o mensual. Incluye
          solicitudes, pagos, vouchers y saldos por caja.
        </Text>
        <Footer />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>8. Módulo Almacén</Text>
        <Text style={s.p}>
        ...
        <Text style={s.h2}>8.1 Registrar compra al almacén central</Text>
        <Step n={1}>
        ...
        <Text style={s.h2}>8.2 Ver stock del almacén central</Text>
        <Text style={s.p}>
        ...
        <Text style={s.h2}>8.3 Salida a obra (desde PWA, residente)</Text>
        <Step n={1}>
        ...
        <Text style={s.h2}>8.4 Devolución</Text>
        <Text style={s.p}>
          Mismo form, tipo "Devolución". El stock central sube y el saldo del proyecto baja.
        </Text>

        <Text style={s.h2}>8.5 Almacén por proyecto</Text>
        <Text style={s.p}>
      ...
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.h2}>9.2 Check-in GPS</Text>
        <Step n={1}>
        ...
        <Text style={s.h2}>9.3 RDO (Parte Diario)</Text>
        ...
        <Text style={s.h2}>9.4 Evidencias fotográficas</Text>
        ...
        <Text style={s.h2}>9.5 SST · Seguridad y Salud en el Trabajo</Text>
        ...
        <Text style={s.h2}>9.6 Documentos del proyecto</Text>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>10. Valorizaciones quincenales y Curva S</Text>
        <Text style={s.p}>
          Las valorizaciones son los cortes quincenales que se cobran al cliente según el avance
          físico de las partidas del proyecto.
        </Text>

        <Text style={s.h2}>10.1 Generar una valorización</Text>
        <Step n={1}>
          <Text style={s.p}>En la ficha del proyecto, click "Valorizaciones" (badge arriba a la derecha).</Text>
        </Step>
        <Step n={2}>
          <Text style={s.p}>"Nueva valorización" → define número, fecha inicio y fecha fin del periodo.</Text>
        </Step>
        <Step n={3}>
          <Text style={s.p}>El sistema copia las partidas del proyecto. Por cada partida, ingresa el avance ejecutado en el periodo.</Text>
        </Step>
        <Step n={4}>
          <Text style={s.p}>Calcula totales automáticamente: monto bruto, IGV, retención, neto.</Text>
        </Step>
        <Step n={5}>
          <Text style={s.p}>"Presentar" → estado pasa a "presentada". Luego gerencia "Aprueba" o "Rechaza".</Text>
        </Step>
        <Step n={6}>
          <Text style={s.p}>"Descargar PDF" — valorización lista para enviar al cliente.</Text>
        </Step>
        <Step n={7}>
          <Text style={s.p}>Cuando el cliente paga, cambia a "Pagada" → puede dispararse auto-movimiento a caja central.</Text>
        </Step>

        <Text style={s.h2}>10.2 Curva S</Text>
        <Text style={s.p}>
          En el detalle del proyecto verás un gráfico de Curva S que compara avance planificado
          vs ejecutado vs valorizado a lo largo del tiempo. Ayuda a detectar desvíos del
          cronograma.
        </Text>

        <Text style={s.h2}>10.3 Adicionales y deductivos</Text>
        <Bullet>Aumentan o reducen el contrato original.</Bullet>
        <Bullet>Quedan en estado "propuesto" hasta aprobación.</Bullet>
        <Bullet>Una vez aprobados, modifican el presupuesto venta del proyecto.</Bullet>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>11. SST · Seguridad y Salud en el Trabajo</Text>
        <Text style={s.p}>
        ...
        <Text style={s.h2}>11.1 Charla de 5 minutos</Text>
        ...
        <Text style={s.h2}>11.2 Observación de seguridad</Text>
        ...
        <Text style={s.h2}>11.3 Incidente</Text>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>12. Documentos del proyecto</Text>
        <Text style={s.p}>
          Repositorio de archivos por proyecto con sistema de visibilidad de 3 niveles.
        </Text>

        <Text style={s.h2}>12.1 Carpetas disponibles</Text>
        ...
        <Text style={s.h2}>12.2 Niveles de visibilidad</Text>
        <View style={s.tableHead}>
        ...
        <Text style={s.h2}>12.3 Acceso</Text>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>13. Dashboard ejecutivo y Auditoría</Text>

        <Text style={s.h2}>13.1 Dashboard (/dashboard)</Text>
        ...
        <Text style={s.h2}>13.2 Motor de alertas automáticas</Text>
        ...
        <Text style={s.h2}>13.3 Auditoría (/auditoria)</Text>
      ...
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.h2}>14.2 Eventos que disparan push</Text>
        <View style={s.tableHead}>
        ...
        <Text style={s.h2}>14.3 Endpoints de diagnóstico</Text>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>15. Tipo de cambio SUNAT</Text>
        <Text style={s.p}>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>16. Flujo end-to-end de una obra</Text>
        <Text style={s.p}>
      ...
      <Page size="A4" style={s.page}>
        <HeaderBar />
        <Text style={s.h1}>17. FAQ y resolución de problemas</Text>
