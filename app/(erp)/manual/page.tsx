...
const SECCIONES = [
  ...
  { num: 7, titulo: 'Módulo Finanzas' },
  { num: 8, titulo: 'Módulo Almacén' },
  { num: 9, titulo: 'PWA Campo (Residente)' },
  { num: 10, titulo: 'Valorizaciones + Curva S' },
  { num: 11, titulo: 'SST' },
  { num: 12, titulo: 'Documentos del proyecto' },
  { num: 13, titulo: 'Dashboard + Auditoría' },
  { num: 14, titulo: 'Notificaciones push' },
  { num: 15, titulo: 'Tipo de cambio SUNAT' },
  { num: 16, titulo: 'Flujo end-to-end' },
  { num: 17, titulo: 'FAQ y troubleshooting' },
];
