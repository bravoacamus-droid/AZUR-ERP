    ...
    <Modal open={nueva} onClose={() => setNueva(false)} title={ns.id ? 'Editar solicitud de pago' : 'Nueva solicitud de pago'}
      ...
      <div className="space-y-2">
        ...
        <label className="flex items-start gap-2 rounded-lg border bg-muted/30 p-2.5 text-sm">
          ...
          <span><span className="font-medium">Gasto ya pagado desde caja chica</span><span className="mt-0.5 block text-xs text-muted-foreground">Al registrarlo Administración o Gerencia queda conciliado de inmediato y suma al proyecto: lo gestionan directamente, sin aprobación ni validación de otra persona. Si lo registra el campo, pasa por el Jefe de Proyectos y la validación del sustento.</span></span>
        </label>
