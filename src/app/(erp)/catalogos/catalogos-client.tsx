  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <p className="text-xs text-muted-foreground">Maestro de jornaleros para el tareo. El residente propone el jornal; el jefe de proyectos lo aprueba/modifica.</p>
