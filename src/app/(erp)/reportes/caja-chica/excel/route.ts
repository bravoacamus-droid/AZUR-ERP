...
export async function GET(req: Request) {
  ...
  ws.mergeCells('B3:I3');
  ws.getCell('B3').value = 'Gastos ya pagados desde caja chica. Los que registra Administración/Gerencia quedan conciliados de inmediato; los que reporta el campo pasan por el Jefe de Proyectos y la validación del sustento.';
